...
(lib.Bitmap6 = function() {
	this.spriteSheet = ss["G2_G4_ntime_power100_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.G2_G4_ntime_power100 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		var cells_die = [20372, 20398, 20420, 20439, 20456, 20471, 20485, 20498, 20510, 20522, 20533, 20543, 20553, 20563, 20573, 20582, 20591, 20599, 20608, 20616, 20624, 20633, 20641, 20648, 20656, 20664, 20672, 20679, 20687, 20695, 20702, 20710, 20718, 20725, 20733, 20741, 20749, 20756, 20764, 20773, 20781, 20789, 20798, 20806, 20815, 20825, 20834, 20844, 20854, 20864, 20875, 20887, 20899, 20912, 20926, 20941, 20958, 20977, 20998, 21024];
		
		var cells_die2 = [16751, 17036, 17276, 17487, 17676, 17848, 18008, 18157, 18298, 18432, 18560, 18683, 18802, 18917, 19029, 19139, 19245, 19350, 19453, 19554, 19654, 19753, 19851, 19948, 20045, 20141, 20237, 20332, 20428, 20524, 20620, 20716, 20813, 20910, 21009, 21108, 21209, 21311, 21415, 21520, 21627, 21737, 21849, 21963, 22081, 22203, 22329, 22459, 22595, 22737, 22886, 23044, 23211, 23390, 23583, 23794, 24028, 24292, 24598, 24965];
		...
		function start_obs() {
			...
			setTimeout (e31_on, cells_die[30]);
				
				function e31_on(){
					effectsA[30].visible = true;
				}
				
			setTimeout (e32_on, cells_die[31]);
				
				function e32_on(){
					effectsA[31].visible = true;
				}
				
			setTimeout (e33_on, cells_die[32]);
				
				function e33_on(){
					effectsA[32].visible = true;
				}
				
			setTimeout (e34_on, cells_die[33]);
				
				function e34_on(){
					effectsA[33].visible = true;
				}
				
			setTimeout (e35_on, cells_die[34]);
				
				function e35_on(){
					effectsA[34].visible = true;
				}
				
			setTimeout (e36_on, cells_die[35]);
				
				function e36_on(){
					effectsA[35].visible = true;
				}
			
			setTimeout (e37_on, cells_die[36]);
				
				function e37_on(){
					effectsA[36].visible = true;
				}
				
			setTimeout (e38_on, cells_die[37]);
				
				function e38_on(){
					effectsA[37].visible = true;
				}
		
			setTimeout (e39_on, cells_die[38]);
				
				function e39_on(){
					effectsA[38].visible = true;
				}
			
			setTimeout (e40_on, cells_die[39]);
				
				function e40_on(){
					effectsA[39].visible = true;
				}
				
			setTimeout (e41_on, cells_die[40]);
				
				function e41_on(){
					effectsA[40].visible = true;
				}
				
			setTimeout (e42_on, cells_die[41]);
				
				function e42_on(){
					effectsA[41].visible = true;
				}
				
			setTimeout (e43_on, cells_die[42]);
				
				function e43_on(){
					effectsA[42].visible = true;
				}
				
			setTimeout (e44_on, cells_die[43]);
				
				function e44_on(){
					effectsA[43].visible = true;
				}
				
			setTimeout (e45_on, cells_die[44]);
				
				function e45_on(){
					effectsA[44].visible = true;
				}
		
			setTimeout (e46_on, cells_die[45]);
				
				function e46_on(){
					effectsA[45].visible = true;
				}
				
			setTimeout (e47_on, cells_die[46]);
				
				function e47_on(){
					effectsA[46].visible = true;
				}
				
			setTimeout (e48_on, cells_die[47]);
				
				function e48_on(){
					effectsA[47].visible = true;
				}
				
			setTimeout (e49_on, cells_die[48]);
				
				function e49_on(){
					effectsA[48].visible = true;
				}
				
			setTimeout (e50_on, cells_die[49]);
				
				function e50_on(){
					effectsA[49].visible = true;
				}
				
			setTimeout (e51_on, cells_die[50]);
				
				function e51_on(){
					effectsA[50].visible = true;
				}
			
			setTimeout (e52_on, cells_die[51]);
				
				function e52_on(){
					effectsA[51].visible = true;
				}
				
			setTimeout (e53_on, cells_die[52]);
				
				function e53_on(){
					effectsA[52].visible = true;
				}
		
			setTimeout (e54_on, cells_die[53]);
				
				function e54_on(){
					effectsA[53].visible = true;
				}
			
			setTimeout (e55_on, cells_die[54]);
				
				function e55_on(){
					effectsA[54].visible = true;
				}
				
			setTimeout (e56_on, cells_die[55]);
				
				function e56_on(){
					effectsA[55].visible = true;
				}
				
			setTimeout (e57_on, cells_die[56]);
				
				function e57_on(){
					effectsA[56].visible = true;
				}
				
			setTimeout (e58_on, cells_die[57]);
				
				function e58_on(){
					effectsA[57].visible = true;
				}
				
			setTimeout (e59_on, cells_die[58]);
				
				function e59_on(){
					effectsA[58].visible = true;
				}
				
			setTimeout (e60_on, cells_die[59]);
				
				function e60_on(){
					effectsA[59].visible = true;
				}
			...
			setTimeout (e61_on, cells_die2[0]);
				
				function e61_on(){
					effectsB[0].visible = true;
				}
				
			setTimeout (e62_on, cells_die2[1]);
				
				function e62_on(){
					effectsB[1].visible = true;
				}
				
			setTimeout (e63_on, cells_die2[2]);
				
				function e63_on(){
					effectsB[2].visible = true;
				}
				
			setTimeout (e64_on, cells_die2[3]);
				
				function e64_on(){
					effectsB[3].visible = true;
				}
				
			setTimeout (e65_on, cells_die2[4]);
				
				function e65_on(){
					effectsB[4].visible = true;
				}
				
			setTimeout (e66_on, cells_die2[5]);
				
				function e66_on(){
					effectsB[5].visible = true;
				}
			
			setTimeout (e67_on, cells_die2[6]);
				
				function e67_on(){
					effectsB[6].visible = true;
				}
				
			setTimeout (e68_on, cells_die2[7]);
				
				function e68_on(){
					effectsB[7].visible = true;
				}
		
			setTimeout (e69_on, cells_die2[8]);
				
				function e69_on(){
					effectsB[8].visible = true;
				}
			
			setTimeout (e70_on, cells_die2[9]);
				
				function e70_on(){
					effectsB[9].visible = true;
				}
				
			setTimeout (e71_on, cells_die2[10]);
				
				function e71_on(){
					effectsB[10].visible = true;
				}
				
			setTimeout (e72_on, cells_die2[11]);
				
				function e72_on(){
					effectsB[11].visible = true;
				}
				
			setTimeout (e73_on, cells_die2[12]);
				
				function e73_on(){
					effectsB[12].visible = true;
				}
				
			setTimeout (e74_on, cells_die2[13]);
				
				function e74_on(){
					effectsB[13].visible = true;
				}
				
			setTimeout (e75_on, cells_die2[14]);
				
				function e75_on(){
					effectsB[14].visible = true;
				}
		
			setTimeout (e76_on, cells_die2[15]);
				
				function e76_on(){
					effectsB[15].visible = true;
				}
				
			setTimeout (e77_on, cells_die2[16]);
				
				function e77_on(){
					effectsB[16].visible = true;
				}
				
			setTimeout (e78_on, cells_die2[17]);
				
				function e78_on(){
					effectsB[17].visible = true;
				}
				
			setTimeout (e79_on, cells_die2[18]);
				
				function e79_on(){
					effectsB[18].visible = true;
				}
				
			setTimeout (e80_on, cells_die2[19]);
				
				function e80_on(){
					effectsB[19].visible = true;
				}
				
			setTimeout (e81_on, cells_die2[20]);
				
				function e81_on(){
					effectsB[20].visible = true;
				}
			
			setTimeout (e82_on, cells_die2[21]);
				
				function e82_on(){
					effectsB[21].visible = true;
				}
				
			setTimeout (e83_on, cells_die2[22]);
				
				function e83_on(){
					effectsB[22].visible = true;
				}
		
			setTimeout (e84_on, cells_die2[23]);
				
				function e84_on(){
					effectsB[23].visible = true;
				}
			
			setTimeout (e85_on, cells_die2[24]);
				
				function e85_on(){
					effectsB[24].visible = true;
				}
				
			setTimeout (e86_on, cells_die2[25]);
				
				function e86_on(){
					effectsB[25].visible = true;
				}
				
			setTimeout (e87_on, cells_die2[26]);
				
				function e87_on(){
					effectsB[26].visible = true;
				}
				
			setTimeout (e88_on, cells_die2[27]);
			
				function e88_on(){
					effectsB[27].visible = true;
				}
				
			setTimeout (e89_on, cells_die2[28]);
				
				function e89_on(){
					effectsB[28].visible = true;
				}
				
			setTimeout (e90_on, cells_die2[29]);
				
				function e90_on(){
					effectsB[29].visible = true;
				}
				
			setTimeout (e91_on, cells_die2[30]);
				
				function e91_on(){
					effectsB[30].visible = true;
				}
				
			setTimeout (e92_on, cells_die2[31]);
				
				function e92_on(){
					effectsB[31].visible = true;
				}
				
			setTimeout (e93_on, cells_die2[32]);
				
				function e93_on(){
					effectsB[32].visible = true;
				}
				
			setTimeout (e94_on, cells_die2[33]);
				
				function e94_on(){
					effectsB[33].visible = true;
				}
				
			setTimeout (e95_on, cells_die2[34]);
				
				function e95_on(){
					effectsB[34].visible = true;
				}
				
			setTimeout (e96_on, cells_die2[35]);
				
				function e96_on(){
					effectsB[35].visible = true;
				}
			
			setTimeout (e97_on, cells_die2[36]);
				
				function e97_on(){
					effectsB[36].visible = true;
				}
				
			setTimeout (e98_on, cells_die2[37]);
				
				function e98_on(){
					effectsB[37].visible = true;
				}
		
			setTimeout (e99_on, cells_die2[38]);
				
				function e99_on(){
					effectsB[38].visible = true;
				}
			
			setTimeout (e100_on, cells_die2[39]);
				
				function e100_on(){
					effectsB[39].visible = true;
				}
				
			setTimeout (e101_on, cells_die2[40]);
				
				function e101_on(){
					effectsB[40].visible = true;
				}
				
			setTimeout (e102_on, cells_die2[41]);
				
				function e102_on(){
					effectsB[41].visible = true;
				}
				
			setTimeout (e103_on, cells_die2[42]);
				
				function e103_on(){
					effectsB[42].visible = true;
				}
				
			setTimeout (e104_on, cells_die2[43]);
				
				function e104_on(){
					effectsB[43].visible = true;
				}
				
			setTimeout (e105_on, cells_die2[44]);
				
				function e105_on(){
					effectsB[44].visible = true;
				}
		
			setTimeout (e106_on, cells_die2[45]);
				
				function e106_on(){
					effectsB[45].visible = true;
				}
				
			setTimeout (e107_on, cells_die2[46]);
				
				function e107_on(){
					effectsB[46].visible = true;
				}
				
			setTimeout (e108_on, cells_die2[47]);
				
				function e108_on(){
					effectsB[47].visible = true;
				}
				
			setTimeout (e109_on, cells_die2[48]);
				
				function e109_on(){
					effectsB[48].visible = true;
				}
				
			setTimeout (e110_on, cells_die2[49]);
				
				function e110_on(){
					effectsB[49].visible = true;
				}
				
			setTimeout (e111_on, cells_die2[50]);
				
				function e111_on(){
					effectsB[50].visible = true;
				}
			
			setTimeout (e112_on, cells_die2[51]);
				
				function e112_on(){
					effectsB[51].visible = true;
				}
				
			setTimeout (e113_on, cells_die2[52]);
				
				function e113_on(){
					effectsB[52].visible = true;
				}
		
			setTimeout (e114_on, cells_die2[53]);
				
				function e114_on(){
					effectsB[53].visible = true;
				}
			
			setTimeout (e115_on, cells_die2[54]);
				
				function e115_on(){
					effectsB[54].visible = true;
				}
				
			setTimeout (e116_on, cells_die2[55]);
				
				function e116_on(){
					effectsB[55].visible = true;
				}
				
			setTimeout (e117_on, cells_die2[56]);
				
				function e117_on(){
					effectsB[56].visible = true;
				}
				
			setTimeout (e118_on, cells_die2[57]);
			
				function e118_on(){
					effectsB[57].visible = true;
				}
				
			setTimeout (e119_on, cells_die2[58]);
				
				function e119_on(){
					effectsB[58].visible = true;
				}
				
			setTimeout (e120_on, cells_die2[59]);
				
				function e120_on(){
					effectsB[59].visible = true;
				}
	...
	// Ebene 7
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ao0F1IAArpIRpAAIAALpg");
	this.shape.setTransform(424.5,339.6);
	...
	this.clock = new cjs.Text("_ _ sec", "18px 'Arial'");
