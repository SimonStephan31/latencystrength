...
(lib.Bitmap6 = function() {
	this.spriteSheet = ss["G4_G2_ntime_power100_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.G4_G2_ntime_power100 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
