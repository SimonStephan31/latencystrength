...
(lib.Bitmap6 = function() {
	this.spriteSheet = ss["G3_G4_ntime_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.G3_G4_ntime = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		var cells_die = [5226, 5578, 5862, 6109, 6332, 6539, 6736, 6925, 7108, 7288, 7465, 7642, 7818, 7996, 8175, 8358, 8544, 8736, 8935, 9141, 9357, 9585, 9828, 10090, 10374, 10689, 11043, 11454, 11948, 12580];
