...
(lib.Bitmap6 = function() {
	this.spriteSheet = ss["static_power50_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.static_power50 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		let selectedA = effectsA.slice(0, 30);   // get half of the randomized array A
		
		for (var i = 0; i < selectedA.length; i++){
		    selectedA[i].visible = true;
		} // loop through it and make all elements visible
		
		let selectedB = effectsB.slice(0, 30);
