...
(lib.Bitmap6 = function() {
	this.spriteSheet = ss["static_power100_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.static_power100 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.pipette_empty.visible = true;
		this.pipette_empty2.visible = true;
		
		this.filling.visible = true;
		...
		let selectedA = effectsA.slice(0, 60);   // get half of the randomized array A
		
		for (var i = 0; i < selectedA.length; i++){
		    selectedA[i].visible = true;
		} // loop through it and make all elements visible
		
		let selectedB = effectsB.slice(0, 60);
		
		for (var i = 0; i < selectedB.length; i++){
		    selectedB[i].visible = true;
		}
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_start},{t:this.btn_reset}]}).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_105},{t:this.pipette},{t:this.pipette2},{t:this.pipette_empty},{t:this.pipette_empty2}]}).wait(1));
